...
const signature = cloudinary.utils.api_sign_request({
    ...
    public_id: 'sample_image1'}, process.env.API_SECRET);
...
const curl_command = 'curl -d "file=' + file + 
   '&api_key=323127161127519&eager=w_400,h_300,c_pad|w_260,h_200,c_crop&public_id=sample_image1' + 
   '&timestamp=' + timestamp +
   '&signature=' + signature +
   '" -X POST http://api.cloudinary.com/v1_1/' + process.env.CLOUD_NAME + '/image/upload';
